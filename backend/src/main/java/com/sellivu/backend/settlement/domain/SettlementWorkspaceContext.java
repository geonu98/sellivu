...
@Entity
@Table(
        name = "settlement_workspace_context",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_workspace_context_workspace",
                        columnNames = "workspace_id"
                )
        }
)
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class SettlementWorkspaceContext {
    ...
    private SettlementWorkspaceContext(
            Long workspaceId,
    ...
    public static SettlementWorkspaceContext createDefault(Long workspaceId) {
        LocalDateTime now = LocalDateTime.now();
        return new SettlementWorkspaceContext(
                workspaceId,
